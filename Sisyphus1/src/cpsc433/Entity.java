...
public class Entity implements Comparable<Entity> {
	...
	/**
	 * Constructs a new object with the same <code>name</code> as the parameter
	 * object.
	 * 
	 * @param e
	 *            another Entity.
	...
	/**
	 * If the parameter object is an <code>Entity</code>, compares the name of
	 * this object with that of the parameter:
	 * <code>name.compareTo(((Entity)arg0).name)</code>. Otherwise throws a
	 * <code>java.lang.ClassCastException</code> exception.
	 * 
	 * @param arg0
	 *            another object ot compare to (hopefully, another
	 *            <em>Entity</em>.
	 * @return -1 if this name is less than the param, 0 if equal, 1 if greater
	 *         than.
	 */
	 ...
	 * If the parameter object is an <code>Entity</code>, compares the name of
	 * this object with that of the parameter:
	 * <code>name.equals(((Entity)arg0).name)</code>. Otherwise returns false.
	 * 
	 * @param arg0
	 *            another object ot compare to (hopefully, another
	 *            <em>Entity</em>.
	 * @return true if the argument is an <em>Entity</em> and the names are
	 *         equal, false otherwise.
	 */
	@Override
	public boolean equals(Object arg0) {
		return (arg0 instanceof Entity) ? name.equals(((Entity) arg0).name)
				: false;
	}
