...
public class SolutionTest {
	...
	public void testSoftConstraint3() {
		...
		assertEquals(1, mySol.getNumberViolations(2));
		assertEquals(-30, mySol.getPenalty(2)); 
	}
	...
	public void testSoftConstraint5() {
		...
		assertEquals(1, mySol.getNumberViolations(4)); 
		assertEquals(-20, mySol.getPenalty(4)); 
	}
	...
	public void testSoftConstraint6() {
		...
		assertEquals(1, mySol.getNumberViolations(5)); 
		assertEquals(-20, mySol.getPenalty(5)); 
	}
